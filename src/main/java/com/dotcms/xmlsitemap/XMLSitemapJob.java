			...
			try {
				...
				for (ContentType type : types) {
					...
					IHTMLPage page = null;
						...
						List<Contentlet> contentlets = APILocator.getContentletAPI().search( "+identifier:" + st.getPagedetail() + " +live:true", 0, 0, "moddate", systemUser, false );
						if ( contentlets != null && !contentlets.isEmpty()) {
							page = APILocator.getHTMLPageAssetAPI().fromContentlet( contentlets.get(0) );
						}
